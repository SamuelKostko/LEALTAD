    ...
    const mapTxSnap = (snap) =>
      snap.docs.map((d) => {
        ...
        return {
          ...
          balanceBefore: data.balanceBefore != null && Number.isFinite(Number(data.balanceBefore)) ? Number(data.balanceBefore) : null,
          balanceAfter: data.balanceAfter != null && Number.isFinite(Number(data.balanceAfter)) ? Number(data.balanceAfter) : null,
